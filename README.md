...
The bulk endpoint accepts the array from `seed_mentions.json`:
...
- No authentication is implemented because the brief explicitly excludes it.
...
- Add OpenAPI documentation and a small read-only dashboard if the API consumers benefit from it.
